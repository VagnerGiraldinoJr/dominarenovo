                      ...
                      @endrole
                        ...
                        <div class="col-lg-3 col-6">
                          ...
                          <div class="small-box bg-success">
                            ...
                            <a href="{{ route($params['main_route'].'.pedido.index')}}" class="small-box-footer">Ver Mais <i class="fas fa-arrow-circle-right"></i></a>
                          </div>
                        </div>
                        ...
                        <div class="col-lg-3 col-6">
                          ...
                          <div class="small-box bg-primary">
                            ...
                            <a href="{{ route($params['main_route'].'.produto.index')}}" class="small-box-footer">Ver Mais <i class="fas fa-arrow-circle-right"></i></a>
                          </div>
                        </div>
                        ...
                        <div class="col-lg-3 col-6">
                          ...
                          <div class="small-box bg-secondary">
                            ...
                            <a href="{{ route($params['main_route'].'.orcamento.index')}}" class="small-box-footer">Ver Mais <i class="fas fa-arrow-circle-right"></i></a>
                          </div>
                        </div>
