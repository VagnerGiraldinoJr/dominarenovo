                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    @if($item->data_saida == NULL)
                                        ...
                                        @else
                                        <a href="https://wa.me/{{$item->veiculo[0]->celular}}?text=Olá!%20Você%20recebeu%20uma%20encomenda!%20Está%20disponível%20na%20portaria.%20" target="_blank" rel="noopener noreferrer" class="btn btn-outline-success btn-xs"><span class="fab fa-whatsapp fa-lg" aria-hidden="true"></span> Enviar mensagem</a>
                                        @endif
                                    @endif
