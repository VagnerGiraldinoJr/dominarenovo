...
(function ($, window, document, undefined) {
    ...
    Plugin.prototype = {
        ...
        createElement: function (el, suffix, data) {
            ...
            if(_this.options.classControlButtons !== '' && $('.'+_this.options.classControlButtons) !== null){
                $(this).parents('.inputWrapper').find('.'+_this.options.classControlButtons).append(add).append(remove);
                console.log($(this));
            }else{
